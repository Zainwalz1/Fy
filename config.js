...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~dJvSXhPmXDYLYlyLEvZd",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "ZAIN-MD",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "zain",           // Owner's name
    DEV: process.env.DEV || "263776030359",                     // Developer's contact number
